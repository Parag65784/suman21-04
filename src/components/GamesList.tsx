...
export function GamesList() {
  ...
  return (
    <div className="relative bg-white dark:bg-[#0A1929] rounded-lg p-6">
      {/* Cricket field lines background decoration */}
      <div className="absolute inset-0 opacity-5 pointer-events-none">
        <div className="absolute left-1/2 top-0 bottom-0 w-px bg-gray-300 dark:bg-white"></div>
        <div className="absolute left-1/4 top-0 bottom-0 w-px bg-gray-300 dark:bg-white"></div>
        <div className="absolute left-3/4 top-0 bottom-0 w-px bg-gray-300 dark:bg-white"></div>
        <div className="absolute top-1/2 left-0 right-0 h-px bg-gray-300 dark:bg-white"></div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {filteredGames.length === 0 && (
            <div className="col-span-full flex flex-col items-center justify-center py-16 text-center">
              <Trophy className="w-16 h-16 text-gray-400 dark:text-[#1A3A5C] mb-4" />
