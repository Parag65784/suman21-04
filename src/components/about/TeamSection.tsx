...
export const TeamSection: React.FC = () => {
  ...
  const team = [
    ...
    },
    {
      ...
      image:
        'https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750'
    },
    {
      name: 'Michael Chen',
      role: 'CTO',
      ...
      image:
        'https://images.pexels.com/photos/614810/pexels-photo-614810.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750'
    },
    {
      name: 'Sarah Johnson',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <p className={`text-xl max-w-3xl mx-auto ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
            The experts behind CrickWin's success, bringing together cricket knowledge and
...
const TeamMember: React.FC<TeamMemberProps> = ({
  ...
  return (
    <div
      className={`group rounded-xl overflow-hidden shadow-xl transition-all duration-1000 transform hover:-translate-y-2 hover:shadow-2xl ${
        isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
      } ${isDark ? 'bg-gradient-to-br from-[#0D3158] to-[#0A2540]' : 'bg-white border'}`}
    ...
    >
      ...
      <div className="p-6">
        <p className={`${isDark ? 'text-gray-300' : 'text-gray-700'} mb-4`}>{bio}</p>
